...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    const phonesAsset = await PIXI.Assets.load("./assets/phone1.png")
    const crackedPhoneAsset = await PIXI.Assets.load("./assets/phone1_2.png")
    const brokenPhoneAsset = await PIXI.Assets.load("./assets/phone1_3.png")
