...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    const phonesAsset = await PIXI.Assets.load("./assets/typeMobile1_1.png")
    ...
    function makeLayout() {
        ...
        time.x = !isLandscape ? innerWidth * 0.38 : innerWidth * 0.08
        ...
        timerText.x = time.x + (time.width / 2) + 10
        timerText.y = time.y
        ...
        miss.x = !isLandscape ? innerWidth * 0.44 : innerWidth / 2
        ...
        score.x = !isLandscape ? innerWidth * 0.44 : innerWidth * 0.85
        ...
        scoreText.x = score.x + (score.width / 2) + 10
        scoreText.y = score.y
